# This file defines the Terraform version and required providers for the app module.
# It ensures compatibility and specifies dependencies for deploying Azure resources like storage accounts and static websites.
